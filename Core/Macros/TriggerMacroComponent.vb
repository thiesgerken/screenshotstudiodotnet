...
Namespace Macros
    Public Class TriggerMacroComponent
        ...
        Public Property Plugin As New Plugin(Of ITriggerManager)
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="TriggerMacroComponent" /> class.
        ''' </summary>
