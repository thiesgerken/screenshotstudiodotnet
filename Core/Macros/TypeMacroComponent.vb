...
Namespace Macros
    Public Class TypeMacroComponent
        ...
        Public Property Plugin As New Plugin(Of IScreenshotType)
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="TypeMacroComponent" /> class.
        ''' </summary>
        Public Sub New()
            MyBase.New()
        End Sub
